  ...
  },
  {
        ...
        inputSchema: {
                ...
                properties: {
                          ...
                          complaint: { type: 'string', description: 'Customer-facing notes/description for the order (e.g. contact info, deal details, reason for visit).' },
                },
        },
  },
  {
        ...
        inputSchema: {
                ...
                properties: {
                          ...
                          complaint: { type: 'string', description: 'Customer-facing notes/description for the order.' },
                },
                required: ['id'],
        },
  },
...
const UPDATE_FIELDS = ['status', 'customerId', 'vehicleId', 'complaint'];
const CREATE_FIELDS = ['customerId', 'vehicleId', 'status', 'locationId', 'complaint'];
